...
class PermissionUtils {
    companion object {
        ...
        fun requestPermission(
            register: ActivityResultRegistry,
            deniedList: MutableList<String>,
            grantList: MutableList<String>
        ) {

            register.register("permissions", ActivityResultContracts.RequestMultiplePermissions()) {
                it.forEach { entry ->
                ...
                Log.e("permission grantList",grantList.toString())
                Log.e("permission deniedList",deniedList.toString())
            }
        }
    }
